...
class TestMaskedTensorflow(TestCase):
    ...
    def test_cat(self):
        """
        Test the `concat` method for two tensors along axis=0.

        Checks that the concatenated output is as expected.
        """
    ...
    def test_zeros_tensor_type_float(self):
        """
        Test the dtype of the tensor gotten from `zeros` method with dtype=tf.float32.
        """
        dtype = tf.float32
    ...
    def test_zeros_mask_value(self):
        ...
        Tests if all values in the mask are zeros.
        """
        zeros = MaskedTensorflow.zeros((1, 2, 3))
    ...
    def test_not_implemented_method(self):
        ...
        Tests that square of tensor is computed as expected.
        """
