...
class MaskedTensor:
    ...
    def arithmetic(self, action: str, other):
        ...
        -------
        :class:`pose_format.tensorflow.masked.tensor.MaskedTensor`
            A new MaskedTensor with the result of the arithmetic operation.
    ...
    def sum(self, axis):
        ...
        -------
        :class:`pose_format.tensorflow.masked.tensor.MaskedTensor`
            new MaskedTensor with sums of the tensor along the specified axis.
    ...
    def div(self, other: "MaskedTensor", in_place=False, update_mask=True):
        ...
        in_place : bool, optional
            Whether to do the division in place. Default is False.
        update_mask : bool, optional
            Whether to update the mask after division. Default is True.

        Returns
        -------
        :class:`pose_format.tensorflow.masked.tensor.MaskedTensor`
            The resulting tensor after division.
        """
    ...
    def transpose(self, perm: List[int]) -> "MaskedTensor":
        ...
        -------
        :class:`pose_format.tensorflow.masked.tensor.MaskedTensor`
            :class:`pose_format.tensorflow.masked.tensor.MaskedTensor` with dimensions transposed according to the given permutation.
    ...
    def gather(self, indexes):
        ...
        -------
        :class:`pose_format.tensorflow.masked.tensor.MaskedTensor`
            new MaskedTensor containing elements gathered from the tensor using the indexes.
    ...
    def rename(self, *names) -> "MaskedTensor":
        ...
        *names : str
        ...
        -------
        :class:`pose_format.tensorflow.masked.tensor.MaskedTensor`
            new MaskedTensor with dimensions renamed.
        """
